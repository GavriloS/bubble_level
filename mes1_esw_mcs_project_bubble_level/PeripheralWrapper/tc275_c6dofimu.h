...
/**
 * @brief 6DOF IMU 14 device address.
 * @details device slave address
 */
#define C6DOFIMU14_ADDRESS                 0x68

/**
 * @def C6DOFIMU14_ERR
 * @brief Error code for the 6-DOF IMU sensor operations.
 *
 * This macro defines the error code returned by functions when an operation
 * fails or an error condition is encountered.
 */
#define C6DOFIMU14_ERR 0x01

/**
 * @def C6DOFIMU14_OK
 * @brief Success code for the 6-DOF IMU device operations.
 *
 * This macro defines the success code returned by functions when an operation
 * completes successfully without any errors.
 */
#define C6DOFIMU14_OK 0x00

/**
 * @def C6DOFIMU14_ACCEL_MAX
 * @brief Maximum accelerometer value.
 *
 * This macro defines the maximum value that can be read from the accelerometer
 * device of the 6-DOF IMU.
 */
#define C6DOFIMU14_ACCEL_MAX 2200

/**
 * @def C6DOFIMU14_ACCEL_MIN
 * @brief Minimum accelerometer value.
 *
 * This macro defines the minimum value that can be read from the accelerometer
 * device of the 6-DOF IMU.
 */
#define C6DOFIMU14_ACCEL_MIN -2200

/**
 * @def OLED_X_MAX
 * @brief Maximum X coordinate for the OLED display.
 *
 * This macro defines the maximum X coordinate value for positioning elements
 * on the OLED display.
 */
#define OLED_X_MAX 96

/**
 * @def OLED_X_MIN
 * @brief Minimum X coordinate for the OLED display.
 *
 * This macro defines the minimum X coordinate value for positioning elements
 * on the OLED display.
 */
#define OLED_X_MIN 0
...
/**
 * @def OLED_Y_MAX
 * @brief Maximum Y coordinate for the OLED display.
 *
 * This macro defines the maximum Y coordinate value for positioning elements
 * on the OLED display.
 */
#define OLED_Y_MAX 96

/**
 * @def OLED_Y_MIN
 * @brief Minimum Y coordinate for the OLED display.
 *
 * This macro defines the minimum Y coordinate value for positioning elements
 * on the OLED display.
 */
#define OLED_Y_MIN 0

/**
 * @brief Structure to hold 3-axis accelerometer data.
 *
 * This structure contains three variables representing the x, y, and z
 * axis readings from a 6-DOF IMU device.
 */
