 ...
 *
 * Holds the state and configuration of the I2C peripheral used by this module.
 */
 ...
 *
 * Represents the configured I2C slave device accessed via the @ref i2c driver
 * instance. Scope is limited to this translation unit.
 */
...
static IfxI2c_I2c_Status write_register(IfxI2c_I2c_Device *device, uint8 reg_addr, uint8 value);
