...
#define WAIT_TIME_LED   500                                                  /* Wait time constant in milliseconds   */
...
void blinkLED(void)
{
    ...
    waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, WAIT_TIME_LED));    /* Wait 500 milliseconds            */
}
